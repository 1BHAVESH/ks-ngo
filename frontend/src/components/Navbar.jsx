      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <Link
              to="/contact"
              className="bg-[#0d3811] text-[#f8f1e3] px-4 py-2 rounded-md hover:bg-forest/90 transition"
            >
              Contact
            </Link>
          </div>
          ...
          <div className="lg:hidden py-4 border-t border-sage">
            <div className="flex flex-col gap-4">
              ...
              <Link
                to="/contact"
                onClick={() => setIsOpen(false)}
                className="bg-forest text-cream text-[#f8f1e3] py-2 rounded-md hover:bg-forest/90 transition"
              >
                Contact
              </Link>
            </div>
