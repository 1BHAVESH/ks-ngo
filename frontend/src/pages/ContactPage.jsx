  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
            ...
            <Card className="border-[#a3b49b] bg-[#fbfdf5] p-8">
              <h2 className="mb-6 text-2xl font-bold text-[#0d3811]">
                Send us a Message
              </h2>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <Button
                  ...
                  className="w-full bg-[#0d3811] cursor-pointer text-[#f8f1e3] hover:bg-forest/90"
                >
      ...
      <section className="bg-cream py-16">
        <div className="container mx-auto px-4">
          <h2 className="mb-8 text-center text-3xl font-bold text-[#0d3811]">
            Find Us
          </h2>
