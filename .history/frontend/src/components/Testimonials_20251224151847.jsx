      ...
      <section className="py-16 bg-[#dee9d4]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-forest mb-6">Join Our Mission Today</h2>
            <p className="text-earth text-lg mb-8 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-forest text-forest hover:bg-cream bg-transparent"
              >
