        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-[#65504a] text-lg leading-relaxed">
              For over a decade, our NGO has been dedicated to the protection and
              welfare of sacred cows. We provide rescue, medical care, nutritious
              food, and safe shelter to abandoned and injured cows.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="group relative h-[320px] overflow-hidden border-sage transition-all duration-300 hover:shadow-xl"
                >
                  {/* DEFAULT STATE */}
                  <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-6 text-center bg-background transition-opacity duration-300 group-hover:opacity-0">
                    <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-sage-light">
                      <Icon className="h-8 w-8 text-[#2F6B3F]" />
                    </div>
                  ...
                  <div className="absolute inset-0 z-20 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                    ...
                    <div className="absolute inset-0 flex flex-col justify-end p-6">
                      ...
                      <p className="mb-4 text-sm leading-relaxed text-sage-light">
                        {service.description}
                      </p>
                      ...
                      <Button
                        asChild
                        size="sm"
                        className="w-full bg-cream text-forest hover:bg-cream/90"
                      >
