    ...
    <div className="min-h-screen">
      ...
      <section className="bg-sage-light py-16">
        <div className="container mx-auto px-4">
          <h1 className="mb-6 text-center text-4xl font-bold text-forest md:text-5xl">
            Contact Us
          </h1>
      ...
      <section className="bg-background py-16">
        <div className="container mx-auto px-4">
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
            ...
            {/* Contact Form */}
            <Card className="border-sage p-8">
...
function InfoCard({ icon: Icon, title, children }) {
  return (
    <Card className="border-sage p-6">
      <div className="flex items-start gap-4">
        <Icon className="mt-1 h-6 w-6 flex-shrink-0 text-forest" />
        <div>
          <h3 className="mb-2 font-bold text-forest">{title}</h3>
          <p className="leading-relaxed text-earth">{children}</p>
        </div>
      </div>
    </Card>
  );
