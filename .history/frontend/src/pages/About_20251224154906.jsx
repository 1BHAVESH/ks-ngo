  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-forest mb-6">Our History</h2>
            <div className="space-y-4 text-earth leading-relaxed text-lg">
              <p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <Card className="p-8 border-sage">
              <h2 className="text-3xl font-bold text-forest mb-4">Our Mission</h2>
            ...
            <Card className="p-8 border-sage">
              <h2 className="text-3xl font-bold text-forest mb-4">Our Vision</h2>
              <p className="text-earth leading-relaxed text-lg">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-forest mb-6">Founder & Trust</h2>
            <div className="space-y-4 text-earth leading-relaxed text-lg">
              <p>
                <strong className="text-forest">Dr. Rajesh Sharma</strong>, a veterinarian with over 20 years of
      ...
      <section className="py-16 bg-cream">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-forest text-center mb-12">Our Values & Ethics</h2>
