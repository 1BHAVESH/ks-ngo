    ...
    <div className="min-h-screen">
      ...
      <section className="bg-sage-light py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-forest text-center mb-6">Our Services & Activities</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-8 max-w-5xl mx-auto">
            {services.map((service, index) => (
              <Card key={index} className="p-8 border-sage hover:shadow-lg transition-shadow">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1">
                    <h2 className="text-2xl font-bold text-forest mb-3">{service.title}</h2>
